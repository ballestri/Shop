...
public class Pannello extends AContainer implements ActionListener {
    ...
    protected JButton btn_magazzino,btn_clienti,btn_prima,btn_close;
    protected Font font;
    ...
    public void initPanel() {
        ...
        btn_clienti = new CreateRoundButton(DesktopRender.formatButton("Gestione", "Clienti"));
        ...
        btn_clienti.setPreferredSize(new Dimension(260, 260));
        btn_clienti.setBackground(new Color(39, 55, 70));
        btn_clienti.setFont(font);
        btn_clienti.setForeground(Color.WHITE);
        btn_clienti.setBorder(new LineBorder(Color.BLACK));
        btn_clienti.setFocusPainted(false);
        btn_clienti.addActionListener(this);

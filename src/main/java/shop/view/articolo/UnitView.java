...
public class UnitView extends JFrame implements ActionListener {
    ...
    void createHeaderArea() {
        ...
        fieldUnita = new JTextField();
        fieldUnita.setCaretColor(Color.BLACK);
        fieldUnita.setBackground(JTF_COLOR);
        fieldUnita.setFont(font);
        fieldUnita.setBorder(new LineBorder(Color.BLACK));
        fieldUnita.setPreferredSize(new Dimension(320, 35));
        fieldUnita.setVisible(false);
    ...
    void createSearchArea() {
        ...
        int i = 0;
        for (Unita unita : loadUnita()) {
            tableModel.addRow(new String[]{String.valueOf(++i), unita.getUnita()});
        }
